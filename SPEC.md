...
Families and friends learn world geography together through a friendly, shared-device game. No timer or typing of answers; four choices keep play light.

## Core experience
1. Add or remove players in setup (minimum 2, maximum 8), then enter nicknames. Grand Adventure (6 turns per player) is the default; 2- and 4-turn trips remain available. Choose Clue Explorer (4 options) or Map Explorer (8 options).
2. Show a handoff screen before every turn. Rotate through all players in roster order.
